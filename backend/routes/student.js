...
const { getDashboard, logActivity, checkUrl, getMyLogs, getFiles, getAnnouncements, markTaskComplete, clearCompletedTasks } = require('../controllers/studentController');
